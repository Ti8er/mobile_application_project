        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(newFullname.isEmpty() || newUsername.isEmpty() || newPassword.isEmpty() ||
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "One or more fields are empty!", Toast.LENGTH_LONG)
                            .show();
                    ...
                    Toast.makeText(getActivity().getApplicationContext(), "Password must have atleast one digit character!", Toast.LENGTH_SHORT).show();
                }
